                  ...
                  <div className="grid lg:grid-cols-2 gap-6 mb-8">
                    {cartoes.map(
                      item => (
                        ...
                        >
                          {!item.verso ? (
                            <div className="relative overflow-hidden rounded-[32px] border border-cyan-400/40 bg-gradient-to-br from-[#001b74] via-[#02145e] to-[#020617] p-8 h-[260px] shadow-[0_0_40px_rgba(0,255,255,0.15)]">
                            ...
                            <div className="rounded-[32px] border border-cyan-400/40 bg-gradient-to-br from-[#001b74] via-[#02145e] to-[#020617] h-[260px] overflow-hidden">
